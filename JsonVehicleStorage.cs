...
namespace VehicleKeeper {
    public static class JsonVehicleStorage {
        ...
        public static void SaveVehicle(SaveableVehicle saveableVehicle) {
            ...
            List<SaveableVehicle> vehicles = GetVehicles().ToList();
        ...
        public static void RemoveVehicle(SaveableVehicle saveableVehicle) {
            ...
            vehicles.Remove(saveableVehicle);
        ...
        public static SaveableVehicle GetVehicle(string ID) {
            try {
                string json = File.ReadAllText(GetFilePath());

                SaveableVehicle[] allVehicles = JsonConvert.DeserializeObject<SaveableVehicle[]>(json, new JsonSerializerSettings {
                    ReferenceLoopHandling = ReferenceLoopHandling.Ignore
                });
